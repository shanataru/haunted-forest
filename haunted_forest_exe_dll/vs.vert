...
smooth out vec3 normal_v;		// normal in eye coordinates by NormalMatrix
smooth out vec2 texCoord_v;
smooth out vec3 position_v;		// vertex in eye coordinates
...
void main()
{
    ...
    normal_v = normalize((normalMatrix * vec4(normal, 0.0)).xyz); 
    texCoord_v = texCoord;
